        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameObject_Lobby_LobbyId",
                        column: x => x.LobbyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Character_Buff_PassiveId",
                        column: x => x.PassiveId,
                        principalTable: "Buff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Character_Price_PriceId",
                        column: x => x.PriceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boss_Biome_BiomeId",
                        column: x => x.BiomeId,
                        principalTable: "Biome",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Boss_Floor_FloorId",
                        column: x => x.FloorId,
                        principalTable: "Floor",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Skin_Character_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Character",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Skin_Price_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Price",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CritChance = table.Column<int>(type: "int", nullable: false),
                    Inaccuracy = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Weapon_Rarity_RarityId",
                        column: x => x.RarityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Biome_FloorId",
                table: "Biome",
                column: "FloorId");

            migrationBuilder.CreateIndex(
                name: "IX_Boss_BiomeId",
                table: "Boss",
                column: "BiomeId");

            migrationBuilder.CreateIndex(
                name: "IX_Boss_FloorId",
                table: "Boss",
                column: "FloorId");

            migrationBuilder.CreateIndex(
                name: "IX_Character_PassiveId",
                table: "Character",
                column: "PassiveId");

            migrationBuilder.CreateIndex(
                name: "IX_Character_PriceId",
                table: "Character",
                column: "PriceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enemy_FloorId",
                table: "Enemy",
                column: "FloorId");

            migrationBuilder.CreateIndex(
                name: "IX_Enemy_LevelId",
                table: "Enemy",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_GameObject_LobbyId",
                table: "GameObject",
                column: "LobbyId");

            migrationBuilder.CreateIndex(
                name: "IX_Level_FloorId",
                table: "Level",
                column: "FloorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Skin_CharacterId",
                table: "Skin",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_Skin_PriceId",
                table: "Skin",
                column: "PriceId");
